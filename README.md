...
- [Video Player Replacer](https://github.com/OpenByteDev/Userscripts/tree/master/Video_Player_Replacer)
- [Wikipedia Donation Request Cleaner](https://github.com/OpenByteDev/Userscripts/tree/master/Wikipedia_Donation_Request_Cleaner)

## Libraries

- [Userscript Config API](https://github.com/OpenByteDev/Userscripts/tree/master/Userscript_Config_API)

## License

All UserScripts and other resources in this repository are licensed under [MIT License](https://github.com/OpenByteDev/Userscripts/blob/master/LICENSE).
